...
const facultyNavItems = [
  { label: "Home", href: "/faculty/dashboard", icon: <FaHome /> },
  {
    label: "Thesis Review",
    href: "/faculty/thesisreview",
    icon: <FaClipboardCheck />,
  },
  { label: "Events", href: "/faculty/events", icon: <FaCalendarAlt /> },
  { label: "Notifications", href: "/faculty/notifications", icon: <FaBell /> },
  {
...
const FacultyHeader = () => {
  ...
  const currentPage = facultyNavItems.find((item) =>
  ...
  const isDashboardPage = activePath === "/faculty/dashboard";
