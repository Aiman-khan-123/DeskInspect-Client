...
const adminNavItems = [
  {
    ...
    icon: <FaCalendarAlt />,
    description:
      "Create and manage academic events, deadlines, and submission schedules",
  },
  {
    ...
    icon: <FaChartLine />,
    description:
      "Monitor thesis submissions, track student performance, and view analytics",
  },
  {
    label: "Reports",
    href: "/admin/reports",
    icon: <FaFileAlt />,
    description:
      "Access evaluation reports, plagiarism checks, and AI detection results",
  },
];
      ...
      <section className="pt-8 pb-8 md:pt-10 md:pb-10 bg-white">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 leading-tight">
            Welcome to
            <span className="block text-[#6B46C1]">DeskInspect Admin</span>
          </h1>

          <p className="text-sm md:text-base text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Monitor events, oversee student progress, and generate insightful
            reports with powerful administrative tools.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-6">
            ...
            <p className="text-base text-gray-600 max-w-2xl mx-auto">
              Quickly access admin functions to manage and monitor DeskInspect
              operations.
            </p>
          </div>
