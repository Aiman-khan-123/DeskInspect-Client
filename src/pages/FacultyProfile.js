...
import StudentHeader from "../components/FacultyHeader"; // You can create a separate FacultyHeader if desired
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-8 p-8 max-w-7xl mx-auto">
        {/* Left Panel */}
        <div className="bg-white shadow-lg rounded-xl p-14 max-w-xs flex-shrink-0 text-center ">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#6B46C1] text-white rounded-lg hover:bg-[#8B5CF6] transition-colors text-sm font-medium cursor-pointer"
            >
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 w-full flex-1">
          ...
          <button
            ...
            className="w-full bg-[#6B46C1] hover:bg-[#8B5CF6] text-white py-2 rounded font-semibold transition duration-200 mb-3"
          >
            Save Changes
          </button>
          ...
          <button
            ...
            className="w-full border border-[#6B46C1] text-[#6B46C1] py-2 rounded font-semibold transition duration-200"
          >
            Change Password
          </button>
        </div>
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded bg-[#6B46C1] text-white hover:bg-[#8B5CF6] text-sm cursor-pointer"
              >
                Submit
              </button>
            </div>
      ...
      <footer className="bg-[#F3F0FF] border-t border-[#E9E3FF] py-4">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm text-[#6B46C1] font-medium">
            © 2025 DeskInspect. All rights reserved. | Faculty Profile
          </p>
        </div>
      </footer>
    </div>
